...
export const WelcomeModal: React.FC<WelcomeModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="relative bg-white rounded-2xl shadow-2xl max-w-3xl w-full mx-4 p-8 sm:p-10 overflow-y-auto max-h-[90vh]"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Título */}
        <h2 className="text-3xl font-bold text-gray-900 mb-2 leading-tight">
          Bienvenido a <span className="italic text-[#242852]">tcboletin.com</span>
        </h2>
        ...
        <div className="space-y-5 text-gray-800 text-base leading-relaxed">
          ...
          <div>
            <h3 className="text-xl font-semibold text-[#242852] mb-2">Nuestros principales valores son:</h3>
            <ul className="list-disc pl-6 space-y-1">
              <li><strong>Educativa:</strong> Ofrecemos recursos que fortalecen tu conocimiento económico.</li>
              <li><strong>Transparencia:</strong> Presentamos datos claros, verificables y actualizados.</li>
              <li><strong>Informativa:</strong> Compartimos contenidos útiles para la toma de decisiones inteligentes.</li>
              <li><strong>Anti-especulación:</strong> Promovemos la ética, la objetividad y el acceso abierto a la información.</li>
            </ul>
          </div>
          ...
          {/* Aviso Legal */}
          <div className="bg-gray-50 border-l-4 border-[#242852] p-4 rounded-md">
            <p className="font-semibold text-[#242852] mb-1">Aviso Legal:</p>
        ...
        <div className="mt-8 flex justify-end">
          <button
            onClick={onClose}
            className="px-6 py-2 rounded-lg bg-[#242852] text-white font-medium hover:bg-[#1e1e3f] transition"
          >
            Entiendo y Acepto
          </button>
        </div>
